...
export function AnimatedInput({ text }: { text: string }) {
  return (
    <div className="font-wa flex items-center gap-2 bg-wa-compose-bg px-[10px] py-[5px]">
      {/* Emoji */}
      <button type="button" className="p-[5px] text-wa-icon-default" aria-hidden tabIndex={-1}>
      ...
      {/* Text area display */}
      <div className="flex flex-1 items-center rounded-lg bg-wa-input-bg px-3 py-[9px] min-h-[38px]">
        <span className="text-[15px] leading-[20px] text-wa-text-primary">
          {text}
          <span className="ml-[1px] inline-block w-[2px] h-[16px] align-middle bg-wa-primary animate-pulse" />
        </span>
      </div>
